...
const commands: Record<string, () => string[]> = {
  ...
  about: () => [
    "Hi, I'm Akshata Gawali!",
    'AI Engineer and Agentic AI Developer focused on production GenAI systems,',
    'RAG pipelines, LangGraph agents, and Python REST APIs on Azure.',
  ],
  skills: () => [
    'Technical Skills:',
    '  AI:       LLMs, RAG, LangChain, LangGraph, Agents, Tool Calling, Vector Search',
    '  Backend:  Python, FastAPI, REST APIs, Azure Functions, PostgreSQL, MySQL',
    '  Cloud:    Azure OpenAI, Azure AI Search, Azure Storage, Document Intelligence',
    '  Tools:    Git, Postman, VS Code, Jupyter, Docker, CI/CD',
  ],
  projects: () => [
    'Featured Projects:',
    '  1. Cora Agent Assist — RAG chatbot (Azure OpenAI + LangChain)',
    '  2. Network Agentic Solution — LangGraph multi-tool agent',
    '  3. Document ingestion + Azure AI Search pipeline',
    '',
    'Visit the Projects tab for more details.',
  ],
  contact: () => [
    'Contact Information:',
    '  Email:    gawaliakshata1@gmail.com',
    '  LinkedIn: linkedin.com/in/akshata-gawali',
    '  Phone:    +91 91758 44533',
  ],
  themes: () => [
    'Available themes:',
